    ...
    <div class="col-lg-6">
         <div class="card">
          ...
          <p id="message" class="error">Error: Invalid input provided.</p>
           ...
           <hr>
           <form method="POST" action="server/insert-new-expenses.php">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="plate_number" name="plate_number" placeholder="Enter Plate Number / pleas use { 000 } for spetiol request" required>
            </div>
            <div class="form-group">
                <label for="amount">Amount</label>
                <input type="number" class="form-control" id="amount" name="amount" placeholder="Enter Amount" required>
                <input type="text" class="form-control" id="status" name="status" placeholder="Enter Amount" value="from-expenses" hidden>
            </div>
            <div class="form-group">
