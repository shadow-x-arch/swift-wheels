<?php require './server/view-expenses.php'; ?>
                            ...
                            <?php elseif (!empty($records)): ?>
                                <?php foreach ($records as $record): ?>
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($record['supervisor_names']); ?></td>
                                        <td><?php echo htmlspecialchars($record['plate_number']); ?></td>
                                        <td><?php echo htmlspecialchars($record['amount']); ?></td>
                                        <td><?php echo htmlspecialchars($record['status']); ?></td>
                                        <td id="comments" onclick="showPopup(this)"><?php echo htmlspecialchars($record['comment']); ?></td>
                                        <td><?php echo htmlspecialchars($record['location']); ?></td>
                                        <td><?php echo htmlspecialchars($record['garage_fees']); ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
                                <tr>
