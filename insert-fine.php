  ...
  <div class="row mt-3">
    ...
    <div class="col-lg-6">
         ...
         <p id="message" class="error">Error: Invalid input provided.</p>
           ...
           <hr>
           <form method="POST" action="server/insert-new-fine.php">
            <div class="form-group">
              <label for="date"> select fine's DATE</label>
            ...
            <div class="form-group">
                <label for="fines">Fines Number</label>
                <input type="text" class="form-control" id="fines_number" name="fines_number" placeholder="Enter Fines Number">
                <input type="text" class="form-control" id="status" name="status" placeholder="Enter Amount" value="pending" hidden>
                <input type="text" class="form-control" id="payed_by" name="payed_by" placeholder="Enter Amount" value="non sellected yet" hidden>
              </div>
            <div class="form-group">
