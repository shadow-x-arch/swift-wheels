    ...
    <div class="col-lg-6">
         <div class="card">
          ...
          <p id="message" class="error">Error: Invalid input provided.</p>
           ...
           <hr>
           <form method="POST" action="server/insert-new-driver.php" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="residence" name="residence" placeholder="Enter Residence" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="responsible_id" name="responsible_id" placeholder="Enter Responsible ID">
            </div>
            <div class="form-group">
                <label for="responsible_phone_number">Responsible Phone Number</label>
                <input type="text" class="form-control" id="responsible_phone_number" name="responsible_phone_number" placeholder="Enter Responsible Phone Number">
            </div>
            <div class="form-group">
                <label for="contract_file">Contract File (PDF/Image)</label>
                <input type="file" class="form-control" id="contract_file" name="contract_file" accept=".pdf,.jpg,.jpeg,.png" required>
            </div>
            <div class="form-group">
                <label for="driving_license_file">Driving License File (PDF/Image)</label>
                <input type="file" class="form-control" id="driving_license_file" name="driving_license_file" accept=".pdf,.jpg,.jpeg,.png" required>
            </div>
            <div class="form-group">
