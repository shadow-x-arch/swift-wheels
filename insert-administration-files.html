    ...
    <div class="col-lg-6">
         <div class="card">
          ...
          <p id="message" class="error">Error: Invalid input provided.</p>
           ...
           <hr>
           <form method="POST" action="server/insert-new-report.php">
            <div class="form-group">
              <label for="payment_date">PAYMENT DATE</label>
              <input type="date" class="form-control" id="payment_date" name="payment_date" required>
          </div>
            <div class="form-group">
                <label for="driver_names">Driver Name</label>
                <input type="text" class="form-control" id="driver_names" name="driver_names" placeholder="Enter Driver Name" required>
            </div>
            <div class="form-group">
